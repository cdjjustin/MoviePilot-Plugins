...
将本仓库地址配置到 MoviePilot **V3** 插件市场的第三方源后刷新市场，即可看到并安装「有声书刮削整理」（需 **≥ 3.0.8**）。

详情页支持手动整理：每本书可点「刮削整理」或「本地整理」，也可一键全部处理；已整理书籍可「重新」整理，并会先清理目标目录中该书的旧输出。主题曲/插曲会进入 S00，正集集号保证唯一。
